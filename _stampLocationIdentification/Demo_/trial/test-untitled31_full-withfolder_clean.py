# -*- coding: utf-8 -*-
"""
Created on Mon Jan 18 22:54:43 2021
...
for file in filenames:  
    ...
    if(len(stamps)>0 and stringmatches):
        print("--------------> normal")
        cv2.imwrite('result/notnormal/normal/'+file,image_withstampLocator)
    else:
        print("--------------> not normal")        
        cv2.imwrite('result/notnormal/notnormal/'+file,image_withstampLocator)
