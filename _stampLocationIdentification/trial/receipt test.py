# -*- coding: utf-8 -*-
"""
Created on Mon Dec 21 14:25:54 2020
...
image = cv2.imread('../TrainTestData/Train/Normal/1 (14).jpg')  
...
custom_config = r'--oem 1 --psm 6 -c tessedit_char_whitelist= "ABCDEFGHIJKLMNOPQRSTUVWXY"'
