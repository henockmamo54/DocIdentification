# -*- coding: utf-8 -*-
"""
Created on Sat Jan  9 16:34:14 2021
...
img = cv2.rectangle(crop_img, 
                        ...
                        (LocationList[_indexOfBC][2]  + padding, LocationList[_indexOfBC][3] - padding),
                        # (LocationList[_indexOfBC][2]  + w, LocationList[_indexOfBC][3] + 30),
                        (120, 255, 0), 5)
