# -*- coding: utf-8 -*-
"""
Created on Mon Jan 11 00:21:10 2021
...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 10 23:25:43 2021
...
for j in range(boxandtext2.shape[0]):
    ...
    if (j in indexes):        
        ...
        for i in indexes:
            ...
            print(i," ",boxandtext2.text[i],distance.euclidean(a, b),a, b)
        ...
        if(horizontaldist<450 and closest != j):
